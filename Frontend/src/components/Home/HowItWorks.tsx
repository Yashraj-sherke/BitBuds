      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {steps.map((step, index) => {
            ...
            return (
              <div key={index} className="relative">
                <div className="glass-card glow-ring hover-card tilt rounded-2xl p-8 shadow-lg text-center">
                  {/* Step Number */}
        ...
        <div className="text-center mt-16">
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-purple-100">
            ...
            <button className="bg-gradient-to-r from-purple-600 to-blue-600 text-white px-8 py-4 rounded-full text-lg font-semibold hover:from-purple-700 hover:to-blue-700 transition-all duration-200 transform hover:scale-105 shadow-lg shine">
