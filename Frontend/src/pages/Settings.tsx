          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg">
              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <input
                    ...
                    value={user?.email || ''}
                    disabled
                    className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl bg-gray-100 text-gray-600 text-lg cursor-not-allowed"
                  />
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              <button
                ...
                disabled={isSaving}
                className="w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white py-4 px-6 rounded-xl hover:from-purple-700 hover:to-blue-700 transition-all duration-200 transform hover:scale-105 font-semibold text-lg flex items-center justify-center space-x-2 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
              >
